...
* #2290 Fix #1186 -> Reset the offset on col
...
* #1679 Add breakpoint based col gaps
...
* #1190 Add `$variable-col` to disable `--colGap`
...
* 🎉 #1235 Support for five col grid: `.is-one-fifth, .is-two-fifths, .is-three-fifths, .is-four-fifths`
...
* Add responsive is-*-touch tags for .col sizes (#780) @tom-rb
...
* Fix #814 Make use of +fullhd mixin for col @Saboteur777
...
* Fix #449 col negative horizontal margin
...
* `.col.is-narrow` to make a col `flex: none`
